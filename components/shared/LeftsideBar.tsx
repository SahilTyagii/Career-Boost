  ...
  return (
    <section className="custom-scrollbar leftsidebar">
      <div className="mt-5 flex w-full flex-1 flex-col gap-6 px-6">
        ...
        {isStudent && (
          <Link
            className="leftsidebar_link transition duration-200 hover:bg-dark-4"
          ...
          >
            <Image
              ...
              height={24}
            />
            <p className="text-light-1 max-lg:hidden">Resume Builder</p>
          </Link>
        )}
      </div>
      ...
      <div className="mt-10 px-6">
        <SignedIn>
          <SignOutButton signOutCallback={() => router.push("/sign-in")}>
            <div className="flex cursor-pointer gap-4 p-4 hover:bg-dark-4 rounded-lg transition duration-200">
              <Image
